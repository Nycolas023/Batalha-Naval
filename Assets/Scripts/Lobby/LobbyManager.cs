...
public class LobbyManager : MonoBehaviour {
    ...
    private async void HandleLobbyPolling() {
        if (joinedLobby != null) {
            ...
            if (lobbyPollTimer < 0f) {
                ...
                if (joinedLobby.Players.Count == 2 && IsLobbyHost() && !alreadyStartedGame) {
                    // Start game if there are 2 players in the lobby
                    StartGame();
                }
            }
        }
    ...
    public void JoinGame(string relayJoinCode) {
